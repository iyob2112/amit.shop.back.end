...
const sendEmail = async (options) => {
  ...
  auth: {
    ...
    // Or use accessToken if refreshToken is not available
...
<body>
  <div class="container">
    <div class="header">
      <a>Prove Your Car mobile Identity</a>
    </div>
    <br />
    <strong>Dear ${options.name},</strong>
    <p>
    ...
    <p style="font-size: 0.9em">
      ...
      message. Ensure the confidentiality of your OTP and do not share
      it with anyone.<br />
      <strong>Do not forward or give this code to anyone.</strong>
      <br />
      <br />
      <strong>Thank you for using Car mobile.</strong>
      <br />
      <br />
      Best regards,
      <br />
      <strong>Car mobile</strong>
    </p>
  ...
  <div style="text-align: center">
    ...
    <div class="email-info">
      <a href="/">Car mobile</a> | [Address]
      | [Address] - [Zip Code/Pin Code], Tigray
    </div>
    <div class="email-info">
      &copy; 2023 Car mobile. All rights
      reserved.
    </div>
  </div>
</body>
